...
public class StringConstant {
    ...
    public static final String BMCLAPI2_FABRIC_MAVEN = "https://bmclapi2.bangbang93.com/maven";
    public static final String FABRIC_MAVEN = "https://maven.fabricmc.net";
    public static final String FABRIC_PREFIX_NAME = "fabric-";
    public static final String META_LOADER_URL = "https://meta.fabricmc.net";
